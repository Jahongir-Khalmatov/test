package lesson2.data_rest.service;

import lesson2.data_rest.entity.Attachment;
import lesson2.data_rest.entity.AttachmentContent;
import lesson2.data_rest.payload.Info;
import lesson2.data_rest.repository.AttachmentContentRepository;
import lesson2.data_rest.repository.AttachmentRepository;
...
public class AttachmentService {
    ...
    @PostMapping("/upload")
    public Info uploadFileDb(MultipartHttpServletRequest request) throws IOException {
        ...
        if (file!=null) {
            ...
            return new Info("file saved",true);
        }
        return new Info("file not saved",false);
